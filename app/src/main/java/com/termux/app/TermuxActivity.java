...
import com.termux.app.adapters.MainPagerAdapter;
...
public final class TermuxActivity extends AppCompatActivity implements ServiceConnection {
    ...
    // Main tabs (Terminals and Desktop)
    ...
    public void onServiceConnected(ComponentName componentName, IBinder service) {
        ...
        // Sessions list is now handled by TerminalsFragment
        // setTermuxSessionsListView();

        final Intent intent = getIntent();
        setIntent(null);

        // Get the session client from TerminalsFragment
        ...
        if (mTermuxService.isTermuxSessionsEmpty()) {
            if (mIsVisible) {
                TermuxInstaller.setupBootstrapIfNeeded(TermuxActivity.this, () -> {
                    ...
                    Runnable launchSession = () -> {
                        ...
                        try {
                            ...
                            if (sessionClient != null) {
                                sessionClient.addNewSession(launchFailsafe, null);
                            }
                    ...
                    if (TermuxInstaller.hasTermBoxAssets(TermuxActivity.this)) {
                        Logger.logInfo(LOG_TAG, "TermUp offline runtime assets found in APK, installing...");
                        TermuxInstaller.installTermBoxRuntime(TermuxActivity.this, launchSession);
                    } else {
                        Logger.logInfo(LOG_TAG, "No TermUp offline runtime assets bundled, continuing with bootstrap only.");
                        launchSession.run();
                    }
                });
            } else {
            ...
            if (!mIsActivityRecreated && intent != null && Intent.ACTION_RUN.equals(intent.getAction())) {
                ...
                if (sessionClient != null) {
                    sessionClient.addNewSession(isFailSafe, null);
                }
            } else {
                if (sessionClient != null) {
                    sessionClient.setCurrentSession(sessionClient.getCurrentStoredSessionOrLast());
                }
            }
        }
        ...
        if (sessionClient != null) {
            mTermuxService.setTermuxTerminalSessionClient(sessionClient);
        }
    }
    ...
    private void setupMainTabs() {
        ...
        // Add tabs
        mMainTabLayout.addTab(mMainTabLayout.newTab().setText(R.string.tab_terminals));
        mMainTabLayout.addTab(mMainTabLayout.newTab().setText(R.string.tab_desktop));
    ...
    public void termuxSessionListNotifyUpdated() {
        if (mTerminalsFragment != null && mTerminalsFragment.getTermuxSessionListViewController() != null) {
            mTerminalsFragment.getTermuxSessionListViewController().notifyDataSetChanged();
        } else if (mTermuxSessionListViewController != null) {
    ...
    public TermuxTerminalViewClient getTermuxTerminalViewClient() {
        if (mTerminalsFragment != null && mTerminalsFragment.getTermuxTerminalViewClient() != null) {
            return mTerminalsFragment.getTermuxTerminalViewClient();
        }
        return mTermuxTerminalViewClient;
    }

    public TermuxTerminalSessionActivityClient getTermuxTerminalSessionClient() {
        if (mTerminalsFragment != null && mTerminalsFragment.getTermuxTerminalSessionClient() != null) {
            return mTerminalsFragment.getTermuxTerminalSessionClient();
        }
