...
struct JniContext {
    ...
    [[nodiscard]]
    JNIEnv *getEnv() const {
        JNIEnv *env = getEnvUnchecked();
        if (env)
            return env;

        abort(); // Just crash if we can't get JNIEnv
    }
};
...
JNI_OnLoad(JavaVM *vm, void *) {
    ...
    if (context.getEnvUnchecked() == nullptr)
        return JNI_ERR;
...
Java_com_termux_app_vnc_VncClient_initLibrary(JNIEnv *env, jclass clazz) {
    if (context.managedCls)
        context.getEnv()->DeleteGlobalRef(context.managedCls);
...
Java_com_termux_app_vnc_VncClient_nativeClientCreate(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_termux_app_vnc_VncClient_nativeConfigure(JNIEnv * /*env*/, jobject /*thiz*/, jlong client_ptr,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_termux_app_vnc_VncClient_nativeSetDest(JNIEnv *env, jobject /*thiz*/, jlong client_ptr,
...
Java_com_termux_app_vnc_VncClient_nativeInit(JNIEnv *env, jobject /*thiz*/, jlong client_ptr,
                                              jstring host, jint port) {
    auto client = (rfbClient *) client_ptr;
...
extern "C"
JNIEXPORT void JNICALL
Java_com_termux_app_vnc_VncClient_nativeCleanup(JNIEnv *env, jobject /*thiz*/,
                                                 jlong client_ptr) {
    auto client = (rfbClient *) client_ptr;
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_termux_app_vnc_VncClient_nativeProcessServerMessage(JNIEnv * /*env*/, jobject /*thiz*/,
                                                              jlong client_ptr) {
    auto client = (rfbClient *) client_ptr;
...
Java_com_termux_app_vnc_VncClient_nativeGetLastErrorStr(JNIEnv *env, jobject/*thiz*/) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_termux_app_vnc_VncClient_nativeSendKeyEvent(JNIEnv * /*env*/, jobject /*thiz*/, jlong client_ptr,
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_termux_app_vnc_VncClient_nativeSendPointerEvent(JNIEnv * /*env*/, jobject /*thiz*/, jlong client_ptr,
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_termux_app_vnc_VncClient_nativeSendCutText(JNIEnv *env, jobject /*thiz*/, jlong client_ptr, jbyteArray bytes,
                                                     jboolean is_utf8) {
    auto client = (rfbClient *) client_ptr;
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_termux_app_vnc_VncClient_nativeIsUTF8CutTextSupported(JNIEnv * /*env*/, jobject /*thiz*/, jlong client_ptr) {
    return (jboolean) (((rfbClient *) client_ptr)->extendedClipboardServerCapabilities != 0);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_termux_app_vnc_VncClient_nativeSetDesktopSize(JNIEnv * /*env*/, jobject /*thiz*/, jlong client_ptr,
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_termux_app_vnc_VncClient_nativeRefreshFrameBuffer(JNIEnv * /*env*/, jobject /*thiz*/, jlong clientPtr) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_termux_app_vnc_VncClient_nativeGetDesktopName(JNIEnv *env, jobject /*thiz*/, jlong client_ptr) {
    auto client = (rfbClient *) client_ptr;
...
Java_com_termux_app_vnc_VncClient_nativeGetWidth(JNIEnv * /*env*/, jobject /*thiz*/, jlong client_ptr) {
    return ((rfbClient *) client_ptr)->width;
}

extern "C"
JNIEXPORT jint JNICALL
Java_com_termux_app_vnc_VncClient_nativeGetHeight(JNIEnv * /*env*/, jobject /*thiz*/, jlong client_ptr) {
    return ((rfbClient *) client_ptr)->height;
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_termux_app_vnc_VncClient_nativeIsEncrypted(JNIEnv * /*env*/, jobject /*thiz*/, jlong client_ptr) {
    return static_cast<jboolean>(((rfbClient *) client_ptr)->tlsSession ? JNI_TRUE : JNI_FALSE);
}

extern "C"
JNIEXPORT void JNICALL
Java_com_termux_app_vnc_VncClient_nativeUploadFrameTexture(JNIEnv * /*env*/, jobject /*thiz*/,
                                                            jlong client_ptr) {
    auto client = (rfbClient *) client_ptr;
    auto ex = getClientExtension(client);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_termux_app_vnc_VncClient_nativeUploadCursorTexture(JNIEnv * /*env*/, jobject /*thiz*/, jlong client_ptr) {
